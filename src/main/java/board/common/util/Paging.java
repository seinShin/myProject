...
public class Paging {
	...
	public static CamelMap initDataMapPage(int rowMax, int pageCount, int rowCount, int nowPage){
		// 첫 로딩시 초기화
	...
	**************************************************/
	...
	public static String getAHref(int nPage, String title, int nowPage){
		...
		if ("first".equals(title)){
			...
			sb.append("<img src=\"/bootstrap/images/common/pre_btn_x2.png\">");
			sb.append("</a>\n");
		} else if ("prev".equals(title)){
			sb.append("<a href=\"javascript:void(0);\" onClick='goPage(").append(nPage).append(")' ").append(" >");
			sb.append("<img src=\"/bootstrap/images/common/pre_btn.png\">");
			sb.append("</a>\n");
		} else if ("next".equals(title)){
			sb.append("<a href=\"javascript:void(0);\" onClick='goPage(").append(nPage).append(")' ").append(" >");
			sb.append("<img src=\"/bootstrap/images/common/next_btn.png\">");
			sb.append("</a>\n");
		} else if ("last".equals(title)){
			sb.append("<a href=\"javascript:void(0);\" onClick='goPage(").append(nPage).append(")' ").append(" >");
			sb.append("<img src=\"/bootstrap/images/common/next_btn_x2.png\">");
			sb.append("</a>\n");
		} else {
	...
	public static List<CamelMap> setRowNum(List<CamelMap> list, int rowMax, int startNum) {
		for(int i=0;i<list.size();i++) {
			CamelMap d = list.get(i);
			d.put("R_NO", ( rowMax + 1)-( startNum + i) );
			list.set(i, d);
		}
		return list;
	}
